...
const StockVisualizationPage = () => {
	const company = {
		logo: "https://images.unsplash.com/photo-1620288627223-53302f4e8c74?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bG9nb3xlbnwwfHwwfHx8MA%3D%3D",
		name: "TechCorp Ltd.",
		symbol: "TCL",
		stockPrice: 125.5,
		totalShares: 100000,
			...
			<div className="bg-gray-800 p-6 rounded-lg shadow-lg max-w-3xl mx-auto">
				...
				<div className="space-y-4">
					...
					<div className="flex justify-between items-center">
						...
						<span className="text-xl font-semibold">{company.totalShares}</span>
					</div>
					<div className="flex justify-between items-center">
